...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-orange-500 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "gradient-primary gradient-primary-hover text-white",
        destructive:
          "bg-red-500 text-gray-50 shadow-sm hover:bg-red-500/90",
        outline:
          "border border-gray-800 bg-transparent shadow-sm hover:bg-orange-950/10",
        secondary:
          "bg-orange-950/10 text-gray-50 shadow-sm hover:bg-orange-950/20",
        ghost: "hover:bg-orange-950/10 hover:text-orange-500",
